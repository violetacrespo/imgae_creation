...
class StableDiffusionProblem(ElementwiseProblem):
    def __init__(self, save_images: bool = False, prompt_parameter: str = ""):
        ...
        # IMPORTANTE: sin **kwargs -> no entra elementwise_runner -> sin multihilo
        super().__init__(
            n_var=4,
            n_obj=2,
            n_constr=1,
    ...
    def _evaluate(self, x, out, *args, **kwargs):
        # (ya no hace falta “evitar colisiones por paralelismo”, pero puedes dejarlo)
        ...
        if self.save_images:
            image_path = os.path.join(carpeta_salida, "imagen.png")
